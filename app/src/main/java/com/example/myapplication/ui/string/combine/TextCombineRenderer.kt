...
import com.example.myapplication.ui.span.creator.DefaultSpanCreator
import com.example.myapplication.ui.span.creator.SpanCreator
...
class TextCombineRenderer(
    ...
    private val spanCreator: SpanCreator = DefaultSpanCreator()
) {
    ...
    private fun createSpannedText(text: CharSequence, textSpans: List<Text.Span>): CharSequence {
        ...
        textSpans.forEach { textSpan ->
            textSpan.spans.forEach { span ->
                spannable.setSpan(
                    spanCreator.createSpan(context = context, span = span),
                    textSpan.start,
                    textSpan.end,
